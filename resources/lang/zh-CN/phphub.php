...
return [
    ...
    'site_intro' => 'Cesium 是高品质的 三维开发者社区，Powered By <a class="popover-with-html" data-content="查看源代码" target="_blank" style="padding-right:8px" href="https://github.com/summerblue/phphub5" data-original-title="" title=""><i class="fa fa-github-alt text-md" aria-hidden="true"></i> PHPHub</a>',
    ...
    'be_nice' => '我们希望 Cesium 能够成为拥有浓厚技术氛围的开发者社区，而实现这个目标，需要我们所有人的共同努力：友善，公平，尊重知识和事实。请严格遵守 - <a href="https://laravel-china.org/topics/3022">社区发帖和管理规范</a>',
    ...
    'Congratulations and Welcome!' => '恭喜，欢迎加入 Cesium 社区！',
    ...
    'Bind Successfully!' => '绑定成功！以后可以使用你的 :driver 账号登录 Cesium 了 ^_^',
    'Actived' => '最近访问',
];
