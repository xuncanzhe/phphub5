  ...
  <div class="container">
    ...
    <div id="top-navbar-collapse" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="{{ (Request::is('categories/'.config('phphub.blog_category_id')) || (isset($topic) && $topic->category_id == config('phphub.blog_category_id'))) ? ' active' : '' }}"><a href="{{ route('categories.show', config('phphub.blog_category_id')) }}">专栏</a></li>
